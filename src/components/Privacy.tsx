    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
                <h1 className="mb-6 mt-6 sm:mb-8 text-2xl sm:text-3xl font-bold leading-tight"> 
                    개인정보처리방침
                </h1>
                <div className="bg-white rounded-lg shadow-sm p-5 sm:p-8 space-y-8 break-words">
                    <section>
                    ...
                    <section>
                        ...
                        <div className="space-y-4 ml-0 sm:ml-4">
                            <div>
                                <ul className="list-disc ml-6 space-y-1">
                                    <li>
                                        이용자 및 법정대리인은 언제든지 자신의 개인정보를 조회하거나 수정할 수 있으며, 가입 해지를
                                        요청할 수 있습니다.
                                    </li>
                                    <li>
                                        개인정보 조회 및 수정은 ‘개인정보변경’메뉴에서, 가입 해지는 ‘회원탈퇴’메뉴를 통해 가능합니다.
                                    </li>
                    ...
                    <section>
                        ...
                        <div>
                            <ul className="list-disc ml-6 space-y-1">
                            <li>
                                쿠키 사용 : 이용자 맞춤형 서비스를 제공하기 위해 쿠키를 사용합니다. 쿠키는 웹사이트가 이용자의
                                브라우저로 전송하는 소량의 데이터로, 이용자의 디바이스에 저장됩니다.
                            </li>
                    ...
                    <section>
                        ...
                        <p className="mb-4">
                        이 개인정보 처리방침은 법령 및 회사 내부 정책에 따라 변경될 수 있습니다. 변경 사항은 회사 홈페이지를
                        통해 공지합니다.
                        </p>
                    </section>
